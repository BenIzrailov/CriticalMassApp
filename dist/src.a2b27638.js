...
},{"./../assets/menubackground.jpg":[["menubackground.de2063fb.jpg","assets/menubackground.jpg"],"assets/menubackground.jpg"],"./../assets/spicy.svg":[["spicy.c01b4fda.svg","assets/spicy.svg"],"assets/spicy.svg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/menu.js":[function(require,module,exports) {
"use strict";
...
var show_spicy = document.getElementById("spicy_check"); //returns startes

function setStarters() {
  var start = menuItems.filter(function (starter) {
    return starter.type === "starters";
  }).sort(function (a, b) {
    return a.menuOrder - b.menuOrder;
  }).map(function (starter) {
    if (starter.spicy === true) {
      return "<p>\n      <span class = spicy_menu> \n      <span> ".concat(starter.name, "</span> \n      <span class = \"price\"> \\$").concat(starter.price.toFixed(2), " </span> \n      </span>\n      </p>");
    } else {
      return "<p>\n    <span> ".concat(starter.name, "</span>\n    <span class=\"price\"> \\$").concat(starter.price.toFixed(2), " </span>\n    </p>");
    }
  }).join("");
...
function setPasta() {
  var pasta = menuItems.filter(function (pasta) {
    return pasta.type === "pasta";
  }).sort(function (a, b) {
    return a.menuOrder - b.menuOrder;
  }).map(function (pasta) {
    if (pasta.spicy === true) {
      return "<p>\n    <span class = spicy_menu> \n    <span>".concat(pasta.name, " </span>\n    <span class = \"price\">\\$").concat(pasta.price.toFixed(2), " </span>\n    </span>\n    </p>");
    } else {
      return "<p>\n    <span>".concat(pasta.name, "</span>\n    <span class=\"price\">\\$").concat(pasta.price.toFixed(2), "</span>\n    </p>");
    }
  }).join("");
...
function setPizza() {
  //returns pizza items
  var pizza = menuItems.filter(function (pizza) {
    ...
    if (pizza.spicy === true) {
      return "<p>\n    <span class = spicy_menu>\n    <span> ".concat(pizza.name, "</span>\n    <span class=\"price\"> \\$").concat(pizza.price.toFixed(2), " </span>\n     </span>\n    </p>");
    } else {
      return "<p>\n     <span>".concat(pizza.name, "</span> \n     <span class=\"price\">\\$").concat(pizza.price.toFixed(2), " </p> </span>\n    </p>");
    }
  }).join("");
  return pizza;
}
